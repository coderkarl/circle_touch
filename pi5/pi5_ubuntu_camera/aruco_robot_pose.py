...
def main() -> int:
    ...
    aruco_dict, detector, params, legacy = SharedBuildArucoDetector(dictionary_name, detector_cfg)
    ...
    stream = SharedRPiCamMJPEGStream(width=cam_w, height=cam_h, hz=fps_target, device=args.device)
